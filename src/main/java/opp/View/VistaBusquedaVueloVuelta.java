...
public class VistaBusquedaVueloVuelta extends javax.swing.JFrame {
    ...
    public VistaBusquedaVueloVuelta(Reserva reserva, ReservaController reservaController, OcupacionAsientosRepository ocupacionRepo) {
        initComponents();
    ...
    private void cargarTabla() {
        List<Vuelo> vuelos = busquedaController.buscarVuelos(
            reserva.getDestino().getNombre(), // invertido: origen es el destino
            reserva.getOrigen().getNombre()   // invertido: destino es el origen
        );
    ...
    modelo.addRow(new Object[]{
        ...
        tablaResultadosVuelta.setModel(modelo);
    }
    ...
    private void initComponents() {
        ...
        tablaResultadosVuelta = new javax.swing.JTable();
        ...
        tablaResultadosVuelta.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(tablaResultadosVuelta);
    ...
    private void btnConfirmar2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmar2ActionPerformed
        int filaSeleccionada = tablaResultadosVuelta.getSelectedRow();
        ...
        LocalDate fechaVuelta = LocalDate.parse(reserva.getFechaVuelta(), formatter);

        Vuelo vueloSeleccionado = new Vuelo(
            reserva.getDestino(), // origen invertido
            reserva.getOrigen(),  // destino invertido
            tablaResultadosVuelta.getValueAt(filaSeleccionada, 2).toString(),
            tablaResultadosVuelta.getValueAt(filaSeleccionada, 3).toString(),
            tablaResultadosVuelta.getValueAt(filaSeleccionada, 4).toString(),
            Double.parseDouble(tablaResultadosVuelta.getValueAt(filaSeleccionada, 5).toString()),
            fechaVuelta
        );

        reservaController.asignarVueloVuelta(reserva, vueloSeleccionado);

        JOptionPane.showMessageDialog(this, "Vuelo de vuelta confirmado");

        VistaAsientosVuelta vistaAsientosVuelta = new VistaAsientosVuelta(reserva, vueloSeleccionado, ocupacionRepo);
        vistaAsientosVuelta.setVisible(true);
    ...
    private javax.swing.JTable tablaResultadosVuelta;
